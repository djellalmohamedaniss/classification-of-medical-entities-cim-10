...
"""
    ...
    - an LSTM layer that extracts sequential features that contributes to the classification
...
with open('./history-lstm.json', 'w') as fp:
    json.dump(trained_model.history, fp)

model.save('./first_cim_classifier-lstm.h5')
