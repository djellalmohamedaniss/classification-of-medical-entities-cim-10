...
from seq2seq import CIMCodeSeq2Seq
from utils.losses import MaskedLoss
from utils.preprocessing import tf_lower_and_split_punctuation, transform_cim_code, tf_lower_and_split_cim, \
...
early_stopping = tf.keras.callbacks.EarlyStopping(monitor='masked_loss', patience=1)

trained_model = seq2seq.fit(dataset, epochs=10, callbacks=[early_stopping])

with open('../cim10-code-seq2seq-cnn1D/history.json', 'w') as fp:
